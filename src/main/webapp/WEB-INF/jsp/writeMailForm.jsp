...
<div class="modal fade" id="simpleSmtpDialog"
	title="<spring:message code="simpleEmail.title"/>"
	style="display: none" role="dialog">
	<input id="emailUtilType" type="hidden"
		value="${emailUtil == null ? 'SIMPLE' : emailUtil.type}" /> <input
		id="emailUtilURL" type="hidden"
		value="${emailUtil == null ? '' : emailUtil.url}" />
			...
			<div class="panel panel-default">
				<label id="simple_email_from_label"> <spring:message
					...
					id="simple_email_to_label"> <spring:message
						code="simpleEmail.to" />
				</label> <label id="simple_email_to"></label> <label
